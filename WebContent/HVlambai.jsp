...
<body>
  ...
  <!--menu-->
<section class="for-full-back color-light padding-top" style="padding-bottom:60px">
    <div class="container">
<div class="row">
  <div class="col-sm-2">
  ...
  <div class="col-sm-8" style="margin-bottom:20px">
        ...
        <thead>
                    ...
                    <tbody>
                        <tr>
                          <td>Toán</td>
                          <td>Bài tập tuần 1 <a href="HVlambaitap.jsp">link</a></td>    
                          <td>Bài thi test <a href="HVlambaithi.jsp">link</a></td>           
                        </tr>
                    </tbody>
        </table>
  </div>
